...
***
```{r, fig.height=10, fig.width=15, echo = F, results = "hide", warning=F, message=F}
ggthemr_reset()
...
***
```{r, fig.height=10, fig.width=15, out.width="500px", echo = F, results = "hide", warning=F, message=F}
ggthemr_reset()
